...
<br /><br />
	...
	<input class="test" type="email" name="emailconnect" placeholder="E-mail"  />
	<input class="test" type="password" name="passconnect" placeholder="Mot de passe" />
<br /><br />
  <input class="btn btn-outline-dark btn-lg btn-block" type="submit" name="formconnexion" value="Se connecter !" />
