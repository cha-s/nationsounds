...
?>
  ...
  <link rel="stylesheet" href="css/photos.css">
    ...
    <form  action="photos.php" method="post" enctype="multipart/form-data">
      <input class="test" type="file" name="img" accept="" capture <?php $img ?> /><br/>
      <input class="test" name="nom_img" type="text" placeholder="Nommez votre photo" <?php $nom_img ?> /><br />
      <input class="test" type="submit" name="upload" value="Valider" />
    </form>
    ...
    <div id="imageContainer" class="center">
      <?php
      if ($hello != NULL){
          ?><img src="upload/<?php echo $hello; ?>"><?php
      }
        else {
