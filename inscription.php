...
<table>
   ...
   <tr>
    <td>
    <label class="td" for="nom"> Nom </label>
    </td>

    <td>
    <input class="test" type="nom" placeholder="Votre nom" id="nom" name="nom" value="<?php if(isset($nom)) { } ?>"/>
    </td>
    </tr>
    <tr>
        <td>
        <label class="td" for="prenom"> Prénom </label>
        </td>

        <td>
        <input class="test" type="prenom" placeholder="Votre prénom" id="prenom" name="prenom" value="<?php if(isset($prenom)) { } ?>"/>
        </td>
    </tr>
    <!-- <tr>
        <td align="right">
    ...
    <tr>
        <td>
        <label class="td" for="email"> E-mail </label>
        </td>
        <td>
        <input class="test" type="email" placeholder="Votre e-mail" id="email" name="email" value="<?php if(isset($email))  { echo $email; } ?>"/>
        </td>
    </tr>
    <tr>
        <td>
        <label class="td" for="pass">Mot de passe </label>
        </td>
        <td>
        <input class="test" type="password" placeholder="Votre mot de passe" id ="pass" name="pass" value="<?php if(isset($pass)) { } ?>"/>
        </td>
    </tr>
    <tr>
        <td>
        <label class="td" for="pass2">Confimation du mot de passe </label>
        </td>
        <td>
        <input class="test" type="password" placeholder="Votre mot de passe" id="pass2" name="pass" value="<?php if(isset($pass)) { } ?>"/>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            <br/>
			<input class="btn btn-outline-danger btn-lg btn-block" type="submit" name="form_inscription" value="Je m'inscris" onclick="a.href='programme.html';"/>
